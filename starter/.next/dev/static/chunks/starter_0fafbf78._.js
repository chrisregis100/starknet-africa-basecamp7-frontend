...
"[project]/starter/context/WalletContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
const WalletContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function WalletProvider({ children }) {
    _s();
    const [isConnected, setIsConnected] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [address, setAddress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [walletName, setWalletName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(WalletContext.Provider, {
        value: {
            isConnected,
            address,
            walletName,
...
_s(WalletProvider, "JmEq/a5jcG0HeKne8k9cOsbe3yM=");
_c = WalletProvider;
function useWallet() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(WalletContext);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$context$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/starter/context/WalletContext.tsx [app-client] (ecmascript)");
...
function ConnectModal({ isOpen, onClose }) {
    _s();
    const { connect } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$context$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"])();
...
_s(ConnectModal, "DM6rGNEpAjad73VdZvloagYLKoE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$context$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"]
    ];
});
_c = ConnectModal;
var _c;
...
"[project]/starter/components/TokenBalance.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TokenBalance() {
    _s();
    const { isConnected } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$context$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"])();
    const [balance, setBalance] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TokenBalance.useEffect": ()=>{
            if (isConnected) {
                setLoading(true);
                // Simulate network request
                const timer = setTimeout({
                    "TokenBalance.useEffect.timer": ()=>{
                        setBalance("1,000.00");
                        setLoading(false);
                    }
                }["TokenBalance.useEffect.timer"], 1500);
                return ({
                    "TokenBalance.useEffect": ()=>clearTimeout(timer)
                })["TokenBalance.useEffect"];
            } else {
                setBalance(null);
            }
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TokenBalance, "0c5aZ52BZMgQjGRVIaYpDcRl3Zo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$context$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"]
    ];
});
...
function DisconnectModal({ isOpen, onClose }) {
    _s();
    const { address, disconnect, walletName } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$context$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"])();
...
_s(DisconnectModal, "z4AEQ9ZVe1WGAXbGtZyncOtkiEo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$context$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"]
    ];
});
...
function Navbar() {
    _s();
    const { isConnected, address } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$context$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"])();
...
_s(Navbar, "LCtkw712WtGJpmZf1/N8kk3pdMM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$context$2f$WalletContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"]
    ];
});
...
"[project]/starter/components/IncreaseButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_c = IncreaseButton;
var _c;
__turbopack_context__.k.register(_c, "IncreaseButton");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/starter/components/DecreaseButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_c = DecreaseButton;
var _c;
__turbopack_context__.k.register(_c, "DecreaseButton");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$components$2f$IncreaseButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/starter/components/IncreaseButton.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$components$2f$DecreaseButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/starter/components/DecreaseButton.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/starter/node_modules/framer-motion/dist/es/render/components/motion/proxy.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/starter/node_modules/framer-motion/dist/es/components/AnimatePresence/index.mjs [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
function Home() {
    _s();
    const [count, setCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$components$2f$DecreaseButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecreaseButton"], {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$components$2f$IncreaseButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IncreaseButton"], {
...
//# sourceMappingURL=starter_0fafbf78._.js.map