...
"[project]/starter/node_modules/@starknet-react/core/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$eventemitter3$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/starter/node_modules/eventemitter3/index.mjs [app-client] (ecmascript) <locals>");
...
// src/query.ts
var __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useInfiniteQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/starter/node_modules/@tanstack/react-query/build/modern/useInfiniteQuery.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/starter/node_modules/@tanstack/react-query/build/modern/useMutation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/starter/node_modules/@tanstack/react-query/build/modern/useQuery.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$formatUnits$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/starter/node_modules/viem/_esm/utils/unit/formatUnits.js [app-client] (ecmascript)");
...
;
var Connector = class extends __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$eventemitter3$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"] {
};
;
;
;
...
var InjectedConnector = class extends Connector {
    ...
    async ready() {
        ...
        return permissions ? permissions.includes(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$starknet$2d$io$2f$types$2d$js$2f$dist$2f$esm$2f$wallet$2d$api$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Permission"].ACCOUNTS) : false;
    }
    async account(provider, paymasterProvider) {
        ...
        return await __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WalletAccount"].connect(provider, this._wallet, void 0, paymasterProvider, true);
    }
    async connect(_args = {}) {
        this.ensureWallet();
        if (!this._wallet) {
    ...
    async switchChain(chainId) {
        await this.request({
            ...
            params: {
                chainId: __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["num"].toHex(chainId)
            }
        });
    }
};
...
var LegacyInjectedConnector = class extends Connector {
                ...
                case "wallet_getPermissions":
                    {
                        if (this._wallet) {
                            return [
                                __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$starknet$2d$io$2f$types$2d$js$2f$dist$2f$esm$2f$wallet$2d$api$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Permission"].ACCOUNTS
                            ];
                        }
                        return [];
                    }
    ...
    onNetworkChanged(network) {
        switch(network){
            ...
            case "SN_MAIN":
                this.emit("change", {
                    chainId: __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$starknet$2d$react$2f$chains$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainnet"].id
                });
                break;
            case "SN_SEPOLIA":
                this.emit("change", {
                    chainId: __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$starknet$2d$react$2f$chains$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sepolia"].id
                });
                break;
            // Braavos
            case "mainnet-alpha":
...
function useInjectedConnectors({ recommended, includeRecommended = "always", order = "alphabetical", shimLegacyConnectors = [] }) {
    const [injectedConnectors, setInjectedConnectors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const refreshConnectors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const connectors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
...
var MockConnector = class extends Connector {
    constructor({ accounts, options }){
        ...
        __publicField(this, "_chainId", __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$starknet$2d$react$2f$chains$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["devnet"].id);
    ...
    async ready() {
        ...
        if (!permissions?.includes(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$starknet$2d$io$2f$types$2d$js$2f$dist$2f$esm$2f$wallet$2d$api$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Permission"].ACCOUNTS)) {
            return false;
        }
        return true;
    }
    ...
    get _account() {
        let account;
        if (this._chainId === __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$starknet$2d$react$2f$chains$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainnet"].id) {
...
function paymasterRpcProvider({ rpc }) {
    return (chain)=>{
        ...
        const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PaymasterRpc"](config);
        return provider;
    };
}
...
;
;
var AccountContext = __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createContext({
    account: void 0,
    address: void 0
});
function useStarknetAccount() {
    const { account, address } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(AccountContext);
    return {
        account,
        address
    };
...
function AccountProvider({ address, account, children }) {
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(AccountContext.Provider, {
        value: {
            account,
            address
        },
...
;
var defaultQueryClient = new __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$queryClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClient"]();
var StarknetContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(void 0);
function useStarknet() {
    const state = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(StarknetContext);
    if (!state) {
...
function useStarknetManager({ chains, provider, paymasterProvider, explorer, connectors = [], autoConnect = false, defaultChainId }) {
    ...
    const connectorRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])();
    const [state, setState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        currentChain: defaultChain,
        currentProvider: defaultProvider,
        currentPaymasterProvider: defaultPaymasterProvider,
        connectors
    });
    const updateChainAndProvider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const handleConnectorChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const disconnect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const connect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
...
function StarknetProvider({ chains, provider, paymasterProvider, connectors, explorer, autoConnect, queryClient, defaultChainId, children }) {
    ...
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
        client: queryClient ?? defaultQueryClient,
        children: /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(StarknetContext.Provider, {
            value: state,
            children: /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(AccountProvider, {
                address,
                account,
                children
            })
...
function starknetChainId(chainId) {
    switch(chainId){
        case __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$starknet$2d$react$2f$chains$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainnet"].id:
            return __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["constants"].StarknetChainId.SN_MAIN;
        case __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$starknet$2d$react$2f$chains$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sepolia"].id:
            return __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["constants"].StarknetChainId.SN_SEPOLIA;
        default:
            return void 0;
    }
}
...
function StarknetConfig({ children, ...config }) {
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(StarknetProvider, {
        ...config,
        children
    });
}
...
function getAddress(address) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateAndParseAddress"])(address);
}
...
function useAccount() {
    ...
    const [state, setState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(connectedAddress === void 0 ? {
        status: "disconnected"
    } : {
        status: "connected",
        connector,
    ...
    const refreshState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
...
function useQuery(args) {
    const base = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...args,
...
function useMutation(args) {
    const base = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])(args);
    return {
        data: base.data,
        error: base.error,
        reset: base.reset,
...
function useInfiniteQuery(args) {
    const base = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useInfiniteQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useInfiniteQuery"])({
        ...args,
        structuralSharing: false
    });
    return {
...
function useWalletRequest(props) {
    ...
    const request = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const requestAsync = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
...
function useContract({ abi: abi2, address, provider: providedProvider }) {
    ...
    const contract = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useContract.useMemo2[contract]": ()=>{
            const provider = providedProvider ? providedProvider : currentProvider;
            if (abi2 && address && provider) {
                return new __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Contract"]({
                    abi: abi2,
                    address,
...
;
;
function useBlockNumber({ blockIdentifier = __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BlockTag"].LATEST, ...props } = {}) {
...
function useInvalidateOnBlock({ enabled = true, queryKey: queryKey14 }) {
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"])();
    const [prevBlockNumber, setPrevBlockNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
...
function useBalance({ token: token_, address, refetchInterval: refetchInterval_, watch = false, enabled: enabled_ = true, blockIdentifier = __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BlockTag"].LATEST, ...props }) {
    ...
    const queryKey_ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
    ...
    const enabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
    ...
    const refetchInterval = refetchInterval_ ?? (blockIdentifier === __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BlockTag"].PRE_CONFIRMED && watch ? DEFAULT_FETCH_INTERVAL : void 0);
    useInvalidateOnBlock({
...
function queryFn2({ chain, token, address, contract, blockIdentifier }) {
    return async ()=>{
        ...
        if (!isNativeCurrency) {
            ...
            symbol = __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shortString"].decodeShortString(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["num"].toHex(symbol_));
        }
        ...
        const formatted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$unit$2f$formatUnits$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatUnits"])(balanceOf, decimals);
        return {
            value: balanceOf,
            decimals,
            symbol,
...
;
function useBlock({ blockIdentifier = __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BlockTag"].LATEST, ...props } = {}) {
    const { provider } = useStarknet();
    return useQuery({
        queryKey: queryKey3({
            blockIdentifier
...
function useCall({ abi: abi2, address, functionName, args, blockIdentifier = __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BlockTag"].LATEST, refetchInterval: refetchInterval_, watch = false, enabled: enabled_ = true, parseArgs, parseResult, ...props }) {
    ...
    const refetchInterval = refetchInterval_ ?? (blockIdentifier === __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BlockTag"].PRE_CONFIRMED && watch ? DEFAULT_FETCH_INTERVAL2 : void 0);
    useInvalidateOnBlock({
        enabled: Boolean(enabled && watch),
        queryKey: queryKey_
    });
...
function useConnect(props = {}) {
    ...
    const connectAsync = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
...
function useContractFactory({ compiledContract, casm, classHash, abi: abi2 }) {
    ...
    const deployContract = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useContractFactory.useCallback6[deployContract]": async (options)=>{
            if (!account) {
            ...
            if (compiledContract && casm) {
                return await __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Contract"].factory({
                    account,
    ...
    }["useContractFactory.useCallback6[deployContract]"], [
        account,
        compiledContract,
        casm,
        classHash,
...
function useEstimateFees({ calls, options, watch = false, enabled: enabled_ = true, ...props }) {
    const { account } = useAccount();
    const queryKey_ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useEstimateFees.useMemo5[queryKey_]": ()=>queryKey5({
                calls,
                options
            })
    }["useEstimateFees.useMemo5[queryKey_]"], [
        calls,
        options
    ]);
    const enabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useEstimateFees.useMemo5[enabled]": ()=>Boolean(enabled_ && calls)
    }["useEstimateFees.useMemo5[enabled]"], [
        enabled_,
        calls
    ]);
    useInvalidateOnBlock({
...
function useEvents({ address, eventName, fromBlock: fromBlock_, toBlock: toBlock_, pageSize }) {
    ...
    const keyFilter = eventName ? [
        __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["num"].toHex(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hash"].starknetKeccak(eventName))
    ] : [];
    const keys = [
        keyFilter
    ];
    ...
    return useInfiniteQuery({
        ...
        initialPageParam: "0",
        getNextPageParam: {
            "useEvents.useInfiniteQuery": (lastPage, _pages)=>lastPage.continuation_token
...
function blockIdentifierToBlockId(blockIdentifier) {
    if (blockIdentifier === null) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BlockTag"].PRE_CONFIRMED;
    }
...
;
function useNonceForAddress({ address, blockIdentifier = __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BlockTag"].LATEST, ...props }) {
    const { provider } = useStarknet();
    return useQuery({
        queryKey: queryKey7({
            address,
...
function usePaymasterEstimateFees({ calls, options, watch = false, enabled: enabled_ = true, ...props }) {
    const { account } = useAccount();
    const queryKey_ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "usePaymasterEstimateFees.useMemo6[queryKey_]": ()=>queryKey8({
                calls,
                options
            })
    }["usePaymasterEstimateFees.useMemo6[queryKey_]"], [
        calls,
        options
    ]);
    const enabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "usePaymasterEstimateFees.useMemo6[enabled]": ()=>Boolean(enabled_ && calls)
    }["usePaymasterEstimateFees.useMemo6[enabled]"], [
        enabled_,
        calls
    ]);
    useInvalidateOnBlock({
...
function usePaymasterGasTokens({ watch = false, enabled: enabled_ = true, ...props } = {}) {
    ...
    const queryKey_ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "usePaymasterGasTokens.useMemo7[queryKey_]": ()=>queryKey9()
    }["usePaymasterGasTokens.useMemo7[queryKey_]"], []);
    const enabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "usePaymasterGasTokens.useMemo7[enabled]": ()=>Boolean(enabled_)
    }["usePaymasterGasTokens.useMemo7[enabled]"], [
        enabled_
    ]);
    useInvalidateOnBlock({
        enabled: Boolean(enabled && watch),
...
function usePaymasterSendTransaction(props) {
    ...
    const send = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "usePaymasterSendTransaction.useCallback7[send]": (args)=>{
            mutate(args || calls || []);
        }
    }["usePaymasterSendTransaction.useCallback7[send]"], [
        mutate,
        calls
    ]);
    const sendAsync = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "usePaymasterSendTransaction.useCallback7[sendAsync]": (args)=>{
            return mutateAsync(args || calls || []);
        }
    }["usePaymasterSendTransaction.useCallback7[sendAsync]"], [
        mutateAsync,
        calls
    ]);
    return {
...
function useStarkAddress({ name, contract, enabled: enabled_ = true, ...props }) {
    ...
    const { chain } = useNetwork();
    const enabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useStarkAddress.useMemo8[enabled]": ()=>Boolean(enabled_ && name)
    }["useStarkAddress.useMemo8[enabled]"], [
        enabled_,
        name
    ]);
    return useQuery({
...
function queryFn9({ name, contract, provider, network }) {
    return async ()=>{
        ...
        const p = new __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Provider"](provider);
        const encodedDomain = encodeDomain(name);
        const result = await p.callContract({
            contractAddress: namingContract,
            entrypoint: "domain_to_address",
            calldata: __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CallData"].compile({
...
var encodeDomain = (domain)=>{
    ...
    for (const subdomain of domain.replace(".stark", "").split(".")){
        encoded.push(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["starknetId"].useEncoded(subdomain).toString(10));
    }
    return encoded;
};
;
...
function useStarkName({ address, contract, enabled: enabled_ = true, ...props }) {
    ...
    const { chain } = useNetwork();
    const enabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useStarkName.useMemo9[enabled]": ()=>Boolean(enabled_ && address)
    }["useStarkName.useMemo9[enabled]"], [
        enabled_,
        address
    ]);
    return useQuery({
...
function useStarkProfile({ address, useDefaultPfp = true, namingContract, identityContract, enabled: enabled_ = true, ...props }) {
    ...
    const enabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useStarkProfile.useMemo10[enabled]": ()=>Boolean(enabled_ && address)
    }["useStarkProfile.useMemo10[enabled]"], [
        enabled_,
        address
    ]);
...
function queryFn11({ address, useDefaultPfp, namingContract, identityContract, network, multicallContract }) {
    return async ()=>{
            ...
            [
                {
                    ...
                    to: hardcoded(naming),
                    selector: hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hash"].getSelectorFromName("address_to_domain")),
                    calldata: [
                        hardcoded(address),
                        hardcoded(0)
                    ]
                },
                {
                    execution: staticExecution(),
                    to: hardcoded(naming),
                    selector: hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hash"].getSelectorFromName("domain_to_id")),
                    calldata: [
                        arrayReference(0, 0)
                    ]
                },
                {
                    ...
                    selector: hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hash"].getSelectorFromName("get_verifier_data")),
                    calldata: [
                        reference(1, 0),
                        hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shortString"].encodeShortString("twitter")),
                ...
                },
                {
                    ...
                    calldata: [
                        reference(1, 0),
                        hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shortString"].encodeShortString("github")),
                        hardcoded(contracts["verifier"]),
                        hardcoded("0")
                    ]
                },
                {
                    ...
                    calldata: [
                        reference(1, 0),
                        hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shortString"].encodeShortString("discord")),
                        hardcoded(contracts["verifier"]),
                        hardcoded("0")
                    ]
                },
                {
                    ...
                    calldata: [
                        reference(1, 0),
                        hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shortString"].encodeShortString("proof_of_personhood")),
                ...
                // PFP
                {
                    ...
                    calldata: [
                        reference(1, 0),
                        hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shortString"].encodeShortString("nft_pp_contract")),
                ...
                },
                {
                    execution: staticExecution(),
                    to: hardcoded(identity),
                    selector: hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hash"].getSelectorFromName("get_extended_verifier_data")),
                    calldata: [
                        reference(1, 0),
                        hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shortString"].encodeShortString("nft_pp_id")),
                        hardcoded("2"),
                        hardcoded(contracts["verifier_pfp"]),
                        hardcoded("0")
                    ]
                },
                {
                    ...
                    to: reference(6, 0),
                    selector: hardcoded(__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hash"].getSelectorFromName("tokenURI")),
                    calldata: [
                        reference(7, 1),
                        reference(7, 2)
                    ]
        ...
        if (Array.isArray(data)) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["starknetId"].useDecoded(data[0].slice(1).map({
                "queryFn11.useDecoded": (val)=>BigInt(val)
            }["queryFn11.useDecoded"])) : void 0;
            ...
            const profile = data.length === 9 ? data[8].slice(1).map((val)=>__TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shortString"].decodeShortString(val.toString())).join("") : void 0;
...
var hardcoded = (arg)=>{
    return new __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CairoCustomEnum"]({
        Hardcoded: arg
    });
};
var reference = (call, pos)=>{
    return new __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CairoCustomEnum"]({
        Reference: __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cairo"].tuple(call, pos)
    });
};
var arrayReference = (call, pos)=>{
    return new __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CairoCustomEnum"]({
        ArrayReference: __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cairo"].tuple(call, pos)
    });
};
var staticExecution = ()=>{
    return new __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CairoCustomEnum"]({
...
var notEqual = (call, pos, value)=>{
    return new __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CairoCustomEnum"]({
        IfNotEqual: __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cairo"].tuple(call, pos, value)
    });
};
...
function useTransactionReceipt({ hash: hash3, watch, enabled: enabled_ = true, ...props }) {
    ...
    const queryKey_ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useTransactionReceipt.useMemo11[queryKey_]": ()=>queryKey13({
                chain,
                hash: hash3
            })
    }["useTransactionReceipt.useMemo11[queryKey_]"], [
        chain,
        hash3
    ]);
    const enabled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useTransactionReceipt.useMemo11[enabled]": ()=>Boolean(enabled_ && hash3)
    }["useTransactionReceipt.useMemo11[enabled]"], [
        enabled_,
        hash3
    ]);
    useInvalidateOnBlock({
...
function jsonRpcProvider({ rpc }) {
    return (chain)=>{
        ...
        const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f$starknet$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RpcProvider"]({
            ...config,
            chainId
        });
        return provider;
...
function slotProvider({ projectId }) {
    return jsonRpcProvider({
        rpc: ()=>{
            const chain = (0, __TURBOPACK__imported__module__$5b$project$5d2f$starter$2f$node_modules$2f40$starknet$2d$react$2f$chains$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSlotChain"])(projectId);
...
//# sourceMappingURL=b0491_%40starknet-react_core_dist_index_7ad5b297.js.map